...
<head>
  <meta charset="utf-8">
  <title>Jagt & Fiskerimagasinet Aarhus - Hjem</title>
...
<main>
  ...
  <article id="main__events">
    <section id="main__events--nak">
      <img class="main__events--img" src="img/jørgen-skoubo.png" alt="Nak & Æd">
    ...
    <section id="main__events--fisketur">
      <img class="main__events--img" src="img/fisketur.png" alt="Nak & Æd">
      <section class="main__events--content">
        <h2>NAK & ÆD -<br>FOREDRAG MED JØRGEN SKOUBO</h2>
        <a href="#">Læs mere her</a>
      </section>
      <section class="main__events--date"><p>28. december</p><p>2017</p></section>
    </section>
  </article>
