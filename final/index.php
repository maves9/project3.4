...
<!--Include video-->
  <div id="main__video">
    ...
    <div id="main__video--iframe">

    </div>
    <div id="cinemagraphs"></div>

    <script async src="https://www.youtube.com/iframe_api"></script>

    <article class="main__webshop">
      <a href="shop_main.php"><section class="main__webshop--outdoor"> <h2>OUTDOOR</h2> </section></a>
      <a href="shop_main.php"><section class="main__webshop--fiskeri"> <h2>FISKERI</h2> </section></a>
      <a href="shop_main.php"><section class="main__webshop--jagt">    <h2>JAGT</h2>    </section></a>
    </article>
...
<!--Events-->
  <article id="main__events">
    <section id="main__events--nak">
      <img class="main__events--img" src="img/jørgen-skoubo.jpg" alt="Foredrag med Jørgen Skoubo fra Nak &amp; Æd">
    ...
    <section id="main__events--fisketur">
      <img class="main__events--img" src="img/fisketur.jpg" alt="Fælles fisketur til Giber Å ved Mårslet">
      <section class="main__events--content">
